...
This blog will be a step-by-step guide to my Git and GitHub workshop, for which all the resources can be found [here](https://github.com/sbk2k1/Git-Github-Workshop). All code snippets will be provided in the different readme files. You can send PRs (even dummy ones), and create issues and I'll merge them. (probably)
